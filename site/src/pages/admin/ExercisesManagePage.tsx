...
export default function ExercisesManagePage(): JSX.Element {
  ...
  const handleEdit = (exercise: Exercise) => {
    ...
    setFormData({
      ...
      execution:
        exercise.sections?.find((s) => s.title === "Ausführung")?.content || "",
    ...
    return (
      <div className="text-center py-12">
        <p className="text-sage-600 dark:text-sage-300">
          Nur Trainer können Übungen verwalten.
        </p>
      </div>
    );
  }
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 bg-amber-50 rounded-lg">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, kneeAltTitle: e.target.value })
                    }
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, kneeAltDesc: e.target.value })
                    }
                ...
                <div className="p-4 bg-blue-50 rounded-lg">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        shoulderAltTitle: e.target.value,
                      })
                    }
                    placeholder="Titel der Alternative"
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        shoulderAltDesc: e.target.value,
                      })
                    }
                    placeholder="Beschreibung..."
                    rows={2}
              ...
              >
                ...
                <div className="flex items-center gap-2 ml-4">
                  ...
                  {exercise.shoulderAlternative && (
                    <span
                      title="Hat Schulter-Alternative"
